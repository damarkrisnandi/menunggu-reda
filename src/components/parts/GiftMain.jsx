...
const Toast = ({isAlert,  message, setShow}) => {
    ...
    return isAlert && !isClose && (
        <div className="fixed top-1 left-auto">
            <div id="toast-success" className={`${animationConstant} ${!showDelay ? "translate-y-16 opacity-0": "translate-y-0 opacity-100"} flex items-center p-4 mb-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow-md dark:text-gray-400 dark:bg-gray-800`} role="alert">
