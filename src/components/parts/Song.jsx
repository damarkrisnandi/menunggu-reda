...
const Song = (props) => {
    ...
    return ( 
        <Fragment>
            ...
            {(<div className={`${animationConstant} bg-header fixed top-0 left-0 right-0 bottom-0 w-full h-screen ${isOpen ? "-translate-y-28 opacity-0 -z-10": "z-50"} overflow-hidden bg-gray-700 bg-opacity-95 flex flex-col items-center justify-center`}>
